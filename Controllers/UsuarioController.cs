...
namespace keisarmindproject.Controllers
{
    public class UsuarioController : Controller
    {
        private readonly keisarmindprojectContext _context;

        public UsuarioController(keisarmindprojectContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Email")] UsuarioModel usuarioModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Email")] UsuarioModel usuarioModel)
        {
